    ...
    public ComputedVariable createComputedVariable(String variable, boolean createDefaultIfNotPresent) {
        ...
        switch (variable) {
            ...
            case ("missile_incoming"):
                return new ComputedVariable(this, variable, partialTicks -> !missilesIncoming.isEmpty() || (world.isClient() && !missilesIncomingStubs.isEmpty()) ? 1 : 0, false);
            case ("missile_lockedonto"):
                return new ComputedVariable(this, variable, partialTicks -> world.isClient() ? (gunsLockedOnCount > 0 ? 1 : 0) : (!gunsLockedOn.isEmpty() || reportedGunsLockedOn > 0 ? 1 : 0), false);
            default: {
                ...
                if (variable.startsWith("missile_") && !variable.endsWith("incoming")) {
                    ...
                    return new ComputedVariable(this, variable, partialTicks -> {
                        //Use actual missiles when loaded, fall back to stubs for long-range.
