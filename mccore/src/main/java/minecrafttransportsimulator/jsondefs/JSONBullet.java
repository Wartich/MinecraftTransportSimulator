...
public class JSONBullet extends AJSONMultiModelProvider {
    ...
    public static class Bullet {
        ...
        @JSONDescription("If true, collision checks will be performed even when chunks are not loaded. This is useful for long-range artillery that needs to hit terrain in unloaded areas. WARNING: This can cause significant TPS loss on versions above 1.12 due to chunk loading. Use sparingly and only when necessary.")
        public boolean unloadedCollisionCheck;
